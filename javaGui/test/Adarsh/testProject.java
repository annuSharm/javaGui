...
public class testProject extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        paper = new Paper(TypeOfPaper.getSelectedItem().toString(), QualityOfPaper.getSelectedItem().toString(), orientationOfPaper.getSelectedItem().toString(), Paper.getPriceOfSize(sizeOfPaper.getSelectedItem().toString()), Float.parseFloat(quantityOfPaper.getText()));
